    ...
    try {
        ...
        const data =  
            ...
            const result = await pool
                    ...
                    .query("exec spDatoRequerimientoBAJSON_Listar @PageNumber, @RowsOfPage, @usrId, @usrIdentificadorSender");
...
export const getBAid = async (req, res) => {
    const { id } = req.params
    res.status(200).json({"message":"Obteniento datos de bandeja de archivados con id: " + id})
}
